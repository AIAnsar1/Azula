...
fn run_rustscan_with_timeout(args: &[&str], timeout: Duration) {
    ...
    let mut child = Command::new("target/debug/azula").args(args).spawn().unwrap();
...
mod timelimits_test {
    ...
    fn scan_azula_cmnatic_co_uk() {
        super::run_rustscan_with_timeout(
            &["--greppable", "--no-nmap", "-u", "5000", "-b", "2500", "azula.cmnatic.co.uk"],
    ...
    fn udp_scan_google_com() {
        super::run_rustscan_with_timeout(
            &["--udp", "--greppable", "-u", "5000", "-b", "2500", "google.com"],
            super::Duration::from_secs(28),
        );
    }
    #[test]
    ...
    fn udp_scan_example_com() {
        super::run_rustscan_with_timeout(
            &["--udp", "--greppable", "-u", "5000", "-b", "2500", "example.com"],
            super::Duration::from_secs(28),
        );
    }
    #[test]
    ...
    fn udp_scan_azula_cmnatic_co_uk() {
        super::run_rustscan_with_timeout(
            &["--udp", "--greppable", "-u", "5000", "-b", "2500", "rustscan.cmnatic.co.uk"],
            super::Duration::from_secs(26),
        );
    }
}